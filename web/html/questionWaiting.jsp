				...
				<c:forEach var="qtw" items="${qtwLt }">
					<div class="QuestionItem">
						...
						<div class="QuestionItem-title">
							<a target="_blank" href="question?questionId=${qtw.object.id }">
									${qtw.object.questionTitle }
							</a>
						</div>
						<div class="QuestionItem-content">
							<a target="_blank" href="question?questionId=${qtw.object.id }" class="button QuestionItem-footer--writeAnswerButton">
