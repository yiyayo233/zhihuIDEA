<%@page import="zhihu.entity.RoundtableEntity"%>
...
<div>
	...
	<div class="caonima">
                    ...
                    <div class="yuanzhuo-roundtables-neirong">
                        <div class="yuanzhuo-roundtables-neirong-tou" style="background: rgb(36, 179, 164)">
                            ...
                            <div class="yuanzhuo-header">
                                <a class="yuanzhuo-header-title " target="_blank " rel="noreferrer noopener ">${rt.roundtableTitle }</a>
                                <a class="yuanzhuo-header-info " target="_blank " rel="noreferrer noopener ">${rt.roundtableIntro }</a>
                                <div class="yuanzhuo-header-infoes ">
                                    <div class="yuanzhuo-header-guests ">
                                        <span>2位嘉宾参与</span>
                                    </div>
                                    <div class="yuanzhuo-header-count ">
                                        <span>${rt.followNum }</span>
                                    </div>
                                </div>
                            </div>
		...
		<div class="big-weiba ">
			<div>
				<a class="next-one " href="<%=path %>/AllRoundTable" target="_blank">查看更多圆桌&nbsp;></a>
			</div>
		</div>
	</div>
	<div class="simazai">
		...
		<div class="big-weiba">
			<div>
				<a class="next-one" href="html/zhuanlan.jsp" target="_blank">查看更多专栏&nbsp;></a>
			</div>
		</div>
	</div>
	<div class="jiewei">
	...
	$(function(){
		...
		$.ajax({
			...
			success:function(result){
				...
				//var name = "1";
				console.log(result);
				$(".zhuanlan-columns").html(" ");
				$.each(result,function(i,obj){
					var $cn = $('<div class="zhuanlan-columCard"></div>');
					var item = $('<a href="<%=path%>/ColumnById?cnId='+obj.id+'" class="zhuanlan-avatar" target="_blank" rel="noreferrer noopener">\n'+
							'<img src="images/zhuanlan/'+obj.columnLOGO+'" alt=""/></a>\n'+
