 ...
 *
 * */
var Topstory_recommendHtml = '                        <div class="Card TopstoryItem">\n' +
    ...
    '                            </div>\n' +
    '                        </div>\n';
var Topstory_followHtml = "<div class=\"Topstory-recommend\">\n" +
    ...
    "                                                <div class=\"AuthorInfo-badgeText\">麻省理工学院 金融学硕士</div>\n" +
    "                                            </div>\n" +
    "                                        </div>\n" +
    "                                    </div>\n" +
    "                                </div>\n" +
    ...
    "                            </div>\n" +
    "                        </div>";
var Topstory_hotHtml = "<div class=\"Topstory-hot HotList\">\n" +
    "                            <div class=\"HotListNav-box\">\n" +
    "                                <div class=\"HotListNav\">\n" +
    "                                    <div class=\"HotListNav-items\">\n" +
    "                                        <a href=\"#\" class=\"HotListNav-item is-active\">全站</a>\n" +
    "                                        <a href=\"#\" class=\"HotListNav-item\">视频</a>\n" +
    "                                        <a href=\"#\" class=\"HotListNav-item\">科学</a>\n" +
    "                                        <a href=\"#\" class=\"HotListNav-item\">数码</a>\n" +
    "                                        <a href=\"#\" class=\"HotListNav-item\">体育</a>\n" +
    "                                        <a href=\"#\" class=\"HotListNav-item\">时尚</a>\n" +
    "                                        <a href=\"#\" class=\"HotListNav-item\">影视</a>\n" +
    "                                    </div>\n" +
    "                                    <button type=\"button\" class=\"button\">展开\n" +
    "                                        <span style=\"display: inline-flex; align-items: center;\">​<svg class=\"Zi Zi--ArrowDown HotListNav-expandButtonIcon\" width=\"10\" height=\"10\" fill=\"currentColor\" viewBox=\"0 0 24 24\"><path d=\"M12 13L8.285 9.218a.758.758 0 0 0-1.064 0 .738.738 0 0 0 0 1.052l4.249 4.512a.758.758 0 0 0 1.064 0l4.246-4.512a.738.738 0 0 0 0-1.052.757.757 0 0 0-1.063 0L12.002 13z\" fill-rule=\"evenodd\"></path></svg></span>\n" +
    "                                    </button>\n" +
    "                                </div>\n" +
    "                            </div>\n" +
    ...
    "                                        <div class=\"HotItem-rank HotItem-hot\">\n" +
    "                                            1\n" +
    "                                        </div>\n" +
    "                                        <div class=\"HotItem-label\">新</div>\n" +
    "                                    </div>\n" +
    "                                    <div class=\"HotItem-content\">\n" +
    "                                        <a href=\"#\">\n" +
    "                                            <h2 class=\"HotItem-title\">如何看待 7 月 11 日仝卓称工作室账号被禁言且直接怼姚晨郑云龙「恶之花抱团」？</h2>\n" +
    "                                            <p class=\"HotItem-text\">迷惑，说工作室言论不代表艺人言论，那工作室拿艺人账号发言也不打算代表艺人言论吗？</p>\n" +
    "                                        </a>\n" +
    ...
    "                                        </div>\n" +
    "                                    </div>\n" +
    "                                    <a href=\"#\" class=\"HotItem-img\">\n" +
    "                                        <img src=\"images/Topstory/v2-410c8fadb334b2da4b2587e0e130b27a_400x224.png\" alt=\"\">\n" +
    "                                    </a>\n" +
    "                                </div>\n" +
    "                                <div class=\"HotItem\">\n" +
    "                                    <div class=\"HotItem-index\">\n" +
...
function UpdateTopstoyHtml(index){
    if(index === 0){
        // $(".Topstory-mainCard-body").html(Topstory_recommendHtml);
        hraderinit();
    }else if (index === 1){
        $(".Topstory-mainCard-body").html(Topstory_followHtml);
    }else {
        $(".Topstory-mainCard-body").html(Topstory_hotHtml);
    }
}

$(function () {
    //$(".Topstory-mainCard-body").html(Topstory_recommendHtml);
    $(".TopstoryTabs-link").click(function () {
        $(this).parent().siblings().children().removeClass("is-active");
        $(this).addClass("is-active");

        UpdateTopstoyHtml($(this).parent().index());
    });
});
