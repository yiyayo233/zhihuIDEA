...
<body>
<div id="divbig">
	<img src="images/signin/v2-a47051e92cf74930bedd7469978e6c08_hd.png" class="do"/>
	<div  id="div1">
		<div class="SignContainer-content">
			<div class="SignContainer-inner">
				<div class="SignFlow" action="" >
					...
					<div class="SignFlow-account">
						<div class="SignFlowInput SignFlow-accountInputBox">
							<label class="SignFlow-accountInput Input-wrapper">
								<input class="Input" name="userName" type="text" placeholder="手机号或邮箱登录">
							</label>
							<div class="SignFlowInput-errorMask SignFlowInput-errorMask--account is-active">
								请输入手机号或邮箱登录
							</div>
						</div>
					</div>
					<div class="SignFlow-password">
						<div class="SignFlowInput SignFlow-passwordInputBox">
							<label class="SignFlow-passwordInput Input-wrapper">
								<input class="Input" name="userpass" type="password" placeholder="请输入密码">
								<!--<button class="button SignFlow-switchPassword button-plain" type="button">
                                    <span style="display: inline-flex; align-items: center;">​<svg class="Zi Zi&#45;&#45;Eye Button-zi" fill="currentColor" viewBox="0 0 24 24" width="1.2em" height="1.2em"><path d="M1 11.5C1 15 7 19 12 19s11-4 11-7.5S17 4 12 4 1 8 1 11.5zm11 5c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm-3-5c0 1.66 1.34 3 3 3s3-1.34 3-3-1.34-3-3-3-3 1.34-3 3z" fill-rule="evenodd"></path></svg></span>
                                </button>-->
							</label>
							<div class="SignFlowInput-errorMask SignFlowInput-errorMask--pass is-active">
								请输入密码
							</div>
						</div>
					</div>
					<!--<div class="SignFlow-password SignFlow-password2">
                        <div class="SignFlowInput SignFlow-passwordInputBox">
                            <label class="SignFlow-passwordInput Input-wrapper">
                                <input class="Input" name="userpassZ" type="password" placeholder="再次输入密码">
                                &lt;!&ndash;<button class="button SignFlow-switchPassword button-plain" type="button">
                                    <span style="display: inline-flex; align-items: center;">​<svg class="Zi Zi&#45;&#45;Eye Button-zi" fill="currentColor" viewBox="0 0 24 24" width="1.2em" height="1.2em"><path d="M1 11.5C1 15 7 19 12 19s11-4 11-7.5S17 4 12 4 1 8 1 11.5zm11 5c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm-3-5c0 1.66 1.34 3 3 3s3-1.34 3-3-1.34-3-3-3-3 1.34-3 3z" fill-rule="evenodd"></path></svg></span>
                                </button>&ndash;&gt;
                            </label>
                        </div>
					...
					<div class="Login-options">
						<button class="button Login-option button--plain" type="button">忘记密码？</button>
					</div>
					<button class="button SignFlow-submitButton Denglu" type="button">登录</button>
				</div>
			</div>
		</div>
		<div class="SignContainer-tip">
			未注册手机验证后自动登录，注册即代表同意
			<a href="javascript:void(0)">《知乎协议》</a>
			<a href="javascript:void(0)">《隐私保护指引》</a>
		</div>
		<div class="Login-socialLogin">
			<span>社交账号登录</span>
			<span>
							<button class="button Login-socialButton" type="button">
	...
	<footer class="SignFlowHomepage-footer">
		...
		<div class="ZhihuRights">
			<span>© 2020 知乎</span>
			<a target="_blank" rel="noopener noreferrer" href="#">京 ICP 证 ****** 号</a>
			<a target="_blank" rel="noopener noreferrer" href="#">京 ICP 备 ******** 号 - *</a>
			<a target="_blank" rel="noopener noreferrer" href="#">
				<img src="images/signin/v2-d0289dc0a46fc5b15b3363ffa78cf6c7.png">京公网安备 *************** 号</a>
			<a href="#" target="_blank" rel="noopener noreferrer">出版物经营许可证</a>
		</div>
