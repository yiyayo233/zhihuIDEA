...
<html>
  <head>
	...
	-->
    <meta charset="UTF-8">
    <title>在闲鱼上专门卖二手平板的 iPad 靠谱吗？ - 知乎</title>
  ...
  <body>
	            ...
	            <div class="QuestionHeader-content">
	                ...
	                <div class="QuestionHeader-side">
	                    <div class="QuestionButtonGroup">
	                        <button type="button" class="button button--primary button--blue">
	                            关注问题
	                        </button>
	        ...
	        <div class="QuestionHerder">
	            <div class="QuestionHerder-content">
	                <div class="QuestionHerder-main">
	                    ...
	                    <h1 class="QuestionHeader-title">在闲鱼上专门卖二手平板的 iPad 靠谱吗？</h1>
	                    <a href="#">
	                    ...
	                    <div>
	                        <div class="QuestionHeader-detail">
	                            <div class="QuestionRichText">
	                                    <span class="ztext">
	                                        <p>最近想买一台iPad，全新买不起，想入手一台二手的，但不知道像闲鱼、转转这样的二手平台可不可靠？</p>
	                                    </span>
	                            </div>
	                        </div>
	                    </div>
	                        ...
	                        <div class="QuestionFollowStatus">
	                            <button type="button" class="button">
	                                <div class="Numboard-itemInner">
	                                    ...
	                                    <div class="Numboard-itemValue">3,342</div>
	                                </div>
	                            </button>
	                            <div class="Numboard-item">
	                                <div class="Numboard-itemInner">
	                                    <div class="Numboard-itemName">被浏览</div>
	                                    <div class="Numboard-itemValue">4,803,893</div>
	                                </div>
	                            </div>
	                        </div>
	                    </div>
	                    ...
	                    <div class="QuestionHerder-main QuestionHerder-footer-main">
	                        ...
	                        <div class="QuestionHeaderActions">
	                            ...
	                            <div class="GoodQuestionAction">
	                                <button type="button" class="button GoodQuestionAction-Btn">
	            ...
	            <div class="Question-mainColum">
	                <div>
	                    <div class="QuestionAnswers-answers">
	                        <div class="Card ViewAll">
	                            <a href="#" class="QuestionMainAction QuestionMainAction-ViewAll">
	                                查看全部 383 个回答
	                            </a>
	                        </div>
	                                ...
	                                <div>
	                                    <div class="list-items">
	                                        <div class="List-herder">
	                                            <h4 class="List-herderText">更多回答</h4>
	                                        </div>
	                                        <div class="list-item">
	                                            <div class="ConstantItem-meta">
	                                                <div class="AuthorInfo">
	                                            ...
	                                            <div class="AnswersContent AnswersContent--unescapable is-collapsed">
	                                                <div class="ConstantItem-inner" style="max-height: 400px;">
	                                                        <span class="ztext">
	                                                            <div class="ztext-cover">
	                                                                <img class="ztext-cover-content" src="images/Topstory/v2-8f954b2da3ee0df2b200b11ee8ce6908_hd.jpg" alt="">
	                                                            </div>
	            ...
	            <div class="Question-sideColum">
	                <div class="Question-sideColum-content">
	                    <div class="Card xDiv">
	                        ...
	                        <div class="tpDiv">
	                            <div><img src="images/answers/4.jpg"></div>
	                            <div>
	                                <h2>双河湾果农</h2>
	                                <p>天地虽大,但有一念向善,心存...</p>
	                            </div>
	                        ...
	                        <div class="hdDiv">
	                            <div>回答 <div>765</div></div>
	                            <div>文章 <div>38</div></div>
	                            <div>关注者 <div class="wzDiv">144,024</div></div>
	                        </div>
	                        <div class="hDiv">
	                            <button type="button" class="Button FollowButton Button--primary Button--blue">
										<span style="display: inline-flex; align-items: center;">​<svg class="Zi Zi--Plus FollowButton-icon" fill="currentColor" viewBox="0 0 24 24" width="1.2em" height="1.2em"><path d="M13.491 10.488s-.012-5.387 0-5.998c-.037-1.987-3.035-1.987-2.997 0-.038 1.912 0 5.998 0 5.998H4.499c-1.999.01-1.999 3.009 0 3.009s5.995-.01 5.995-.01v5.999c0 2.019 3.006 2.019 2.997 0-.01-2.019 0-5.998 0-5.998s3.996.009 6.004.009c2.008 0 2.008-3-.01-3.009h-5.994z" fill-rule="evenodd">
	
										</path></svg></span>
	                                <span class="gzsp">关注他</span>
	                                <!--<span class="ygzsp">已关注</span>
	                                <span>取消关注<span>-->
	                            </button>
	...
	<script type="text/javascript" src="Scripts/Header-TopstoryRecommend.js"></script>
  </body>
</html>
