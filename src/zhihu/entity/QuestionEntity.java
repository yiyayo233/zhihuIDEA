...
public class QuestionEntity {
    ...
    public QuestionEntity(String id, String authorId, String questionTitle, String questionIntro, int approveNum, int browseNum, int followNum, String commentId, String publishTime) {
        this.id = id;
        this.authorId = authorId;
        this.questionTitle = questionTitle;
        this.questionIntro = questionIntro;
